...
// Lazy-loads Three.js only when the CTA banner approaches the viewport
...
(function () {
  ...
  // Lazy-load: only import Three.js when section is near viewport
  var loaded = false;
  var observer = new IntersectionObserver(function (entries) {
    if (entries[0].isIntersecting && !loaded) {
      loaded = true;
      observer.disconnect();
      import('./three.min.js').then(function (THREE) {
        initAurora(THREE, canvas, section);
      });
    }
  }, { rootMargin: '200px' });
  observer.observe(section);

  function initAurora(THREE, canvas, section) {
    // GLSL simplex noise
    var noiseGLSL = [
    ...
    var ribbonConfigs = [
      { c1: [0.42, 0.62, 0.23], c2: [0.25, 0.55, 0.35], c3: [0.60, 0.78, 0.40], y: 0.8, speed: 0.22, waveAmp: 0.5, opacity: 0.4, noise: 0.35, width: 1.8 },
      { c1: [0.30, 0.50, 0.18], c2: [0.45, 0.65, 0.28], c3: [0.78, 0.66, 0.43], y: -0.3, speed: 0.17, waveAmp: 0.65, opacity: 0.3, noise: 0.3, width: 2.2 },
      { c1: [0.20, 0.48, 0.32], c2: [0.50, 0.72, 0.35], c3: [0.35, 0.60, 0.30], y: 1.6, speed: 0.28, waveAmp: 0.4, opacity: 0.25, noise: 0.45, width: 1.4 },
      { c1: [0.55, 0.75, 0.40], c2: [0.35, 0.55, 0.22], c3: [0.82, 0.75, 0.55], y: -1.0, speed: 0.2, waveAmp: 0.55, opacity: 0.18, noise: 0.28, width: 2.5 },
      { c1: [0.38, 0.58, 0.25], c2: [0.55, 0.72, 0.38], c3: [0.28, 0.50, 0.30], y: 0.0, speed: 0.24, waveAmp: 0.45, opacity: 0.22, noise: 0.4, width: 1.6 }
    ];
